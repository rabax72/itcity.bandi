...
#
#  $ bin/test -s itcity.bandi -t test_example.robot --all
#
# Run this robot test with robot server (which is faster):
#
# 1) Start robot server:
#
# $ bin/robot-server --reload-path src itcity.bandi.testing.ITCITY_BANDI_ACCEPTANCE_TESTING
#
# 2) Run robot tests:
#
# $ bin/robot src/itcity/bandi/tests/robot/test_example.robot
#
